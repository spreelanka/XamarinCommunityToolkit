...
namespace Xamarin.CommunityToolkit.UI.Views
{
	...
	/// </summary>
	using Xamarin.CommunityToolkit.MauiCompat; public class DrawingViewRenderer : ViewRenderer<DrawingView, UIView>
	{
		...
		public override void TouchesMoved(NSSet touches, UIEvent? evt)
		{
			...
			SetNeedsDisplay();
			currentLine?.Points.Add(Microsoft.Maui.Platform.CoreGraphicsExtensions.ToPoint(currentPoint));
		}
