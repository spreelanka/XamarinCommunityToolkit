...
{
	using Xamarin.CommunityToolkit.MauiCompat; public class MediaElementRenderer : FrameLayout, IVisualElementRenderer, IViewRenderer, MediaPlayer.IOnCompletionListener, MediaPlayer.IOnInfoListener, MediaPlayer.IOnPreparedListener, MediaPlayer.IOnErrorListener
	{
		...
		void IVisualElementRenderer.SetElement(VisualElement element)
		{
			...
			var currentColor = oldElement?.BackgroundColor ?? new Microsoft.Maui.Graphics.Color();
