...
using RectF = Android.Graphics.RectF;namespace Xamarin.CommunityToolkit.UI.Views
{
	class CameraFragment : Fragment, TextureView.ISurfaceTextureListener
	{
		...
		void LogError(string desc, Java.Lang.Exception? ex = null)
		{
			...
			(Microsoft.Maui.Controls.Application.Current?.Handler.MauiContext?.Services.GetService(typeof(ILogger)) as ILogger)?.LogWarning("CameraView", sb.ToString());
		}
