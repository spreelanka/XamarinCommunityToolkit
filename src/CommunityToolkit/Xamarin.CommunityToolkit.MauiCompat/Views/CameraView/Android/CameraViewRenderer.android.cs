...
namespace Xamarin.CommunityToolkit.UI.Views
{
	public class CameraViewRenderer : FrameLayout, IVisualElementRenderer, IViewRenderer
	{
		...
		FragmentManager FragmentManager => fragmentManager ??= Microsoft.Maui.Platform.ContextExtensions.GetFragmentManager(Context ?? throw new NullReferenceException()) ?? throw new InvalidOperationException();
		...
		SizeRequest IVisualElementRenderer.GetDesiredSize(int widthConstraint, int heightConstraint)
		{
			...
			var result = new SizeRequest(new Size(MeasuredWidth, MeasuredHeight), new Size(Microsoft.Maui.Platform.ContextExtensions.ToPixels(Context, 20), Microsoft.Maui.Platform.ContextExtensions.ToPixels(Context, 20)));
			return result;
		}
