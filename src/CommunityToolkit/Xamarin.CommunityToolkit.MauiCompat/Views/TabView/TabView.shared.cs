...
namespace Xamarin.CommunityToolkit.UI.Views
{
	...
	public class TabView : ContentView, IDisposable
	{
		...
		public TabView()
		{
			...
			if (Device.RuntimePlatform == Device.MacCatalyst || Device.RuntimePlatform == Device.UWP)
		...
		public static readonly BindableProperty TabStripBackgroundColorProperty =
			BindableProperty.Create(nameof(TabStripBackgroundColor), typeof(Color), typeof(TabView), new Microsoft.Maui.Graphics.Color(),
		...
		public static readonly BindableProperty TabStripBorderColorProperty =
			BindableProperty.Create(nameof(TabStripBorderColor), typeof(Color), typeof(TabView), new Microsoft.Maui.Graphics.Color(),
		...
		public static readonly BindableProperty TabContentBackgroundColorProperty =
			BindableProperty.Create(nameof(TabContentBackgroundColor), typeof(Color), typeof(TabView), new Microsoft.Maui.Graphics.Color(),
		...
		public static readonly BindableProperty TabIndicatorColorProperty =
			BindableProperty.Create(nameof(TabIndicatorColor), typeof(Color), typeof(TabView), new Microsoft.Maui.Graphics.Color(),
		...
		void AddTabViewItem(TabViewItem tabViewItem, int index = -1)
		{
			...
			if (tabViewItem.ControlTemplate == null)
			{
				...
				else if (Device.RuntimePlatform == Device.iOS || Device.RuntimePlatform == Device.MacCatalyst)
		...
		{
			if (TabStripBorderColor == new Microsoft.Maui.Graphics.Color())
				return;
