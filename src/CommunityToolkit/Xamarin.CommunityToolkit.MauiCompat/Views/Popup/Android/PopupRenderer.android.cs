...
namespace Xamarin.CommunityToolkit.UI.Views
{
	public class PopupRenderer : Dialog, IVisualElementRenderer, IDialogInterfaceOnCancelListener
	{
		...
		Microsoft.Maui.Controls.Platform.Compatibility.ContainerView? container;
		bool isDisposed;
		...
		void CreateControl(in BasePopup basePopup)
		{
			if (container == null)
			{
				container = new Microsoft.Maui.Controls.Platform.Compatibility.ContainerView(Context, basePopup.Content, Microsoft.Maui.Controls.Application.Current?.Handler.MauiContext);
		...
		void SetSize(in BasePopup basePopup)
		{
			if (basePopup.Content != null && basePopup.Size != default)
			{
				...
				var realWidth = (int)Microsoft.Maui.Platform.ContextExtensions.ToPixels(Context, basePopup.Size.Width);
				var realHeight = (int)Microsoft.Maui.Platform.ContextExtensions.ToPixels(Context, basePopup.Size.Height);

				var realContentWidth = (int)Microsoft.Maui.Platform.ContextExtensions.ToPixels(Context, basePopup.Content.WidthRequest);
				var realContentHeight = (int)Microsoft.Maui.Platform.ContextExtensions.ToPixels(Context, basePopup.Content.HeightRequest);
