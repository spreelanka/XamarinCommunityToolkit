...
using Microsoft.Maui.Controls.Compatibility.Platform.UWP;using Microsoft.Maui.Platform;
...
namespace Xamarin.CommunityToolkit.UI.Views
{
	public class PopupRenderer : Flyout, IVisualElementRenderer
	{
		...
		void SetBorderColor()
		{
			...
			if (Element == null)
			{
				(Microsoft.Maui.Controls.Application.Current?.Handler.MauiContext?.Services.GetService(typeof(ILogger)) as ILogger)?.LogWarning("warning", "The PopUpView is null.");
				return;
			}
